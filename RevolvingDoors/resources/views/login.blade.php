...
<html lang="en">
  <head>
    ...
    <title>International Revolving Door</title>
    ...
    <div class="col-xs-4 col-xs-offset-4 text-center login-container">
        <form class="form-horizontal loginform">
                    ...
                    <div class="form-group">
                                <label for="inputName" class="col-lg-4 control-label">Username</label>
                                <div class="col-lg-8">
                    ...
                    <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="password" class="form-control" id="inputName" name="inputName">
                                </div>
                    </div>
                    <div class="form-group">
     ...
     <footer>
        ...
        <a href="#" class="btn btn-primary btn-xs active log-in-button" role="button">Log-In</a>
